...
| Component | Purpose |
|-----------|---------|
| **Communication Protocols** | Named pipes, message queues, state sharing |
| **Agent Lifecycle** | Watchdog process, health monitoring, graceful shutdown |
...
| **Orchestration Modes** | Event-driven, Sequential, Polling, HITL |
