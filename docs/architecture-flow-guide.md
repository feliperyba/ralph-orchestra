...
./.claude/scripts/ralph-event-session.ps1
    ...
    │       │
    │       ├─► Creates .claude/session/messages/{agent}/ directories
    ...
    └─► Start PM Coordinator (terminal 1)
            ...
            │       └─► Begin coordination
            │
            ├─► Send task_assign message to worker
            │       │
            │       └─► .claude/session/messages/developer/msg-{timestamp}.json
            │
...
│   └── msg-qa-20250123-120500-001.json
│
├── developer/             # Developer's inbox
│   ├── msg-pm-20250123-120100-001.json
│   └── msg-pm-20250123-120500-002.json
│
├── qa/                    # QA's inbox
│   ├── msg-developer-20250123-120300-001.json
│   └── msg-pm-20250123-120700-001.json
│
...
│   └── ...
│
└── watchdog/              # Watchdog's inbox (for status)
    ├── msg-developer-20250123-120200-001.json
    ├── msg-qa-20250123-120400-001.json
    └── msg-pm-20250123-120600-001.json
```
...
├─────────────────────────────────────────────────────────────────────┤
│                                                                     │
│  Check inbox: .claude/session/messages/developer/                  │
│       │                                                            │
│       ├─► Found task_assign message?                              │
│       │       │                                                   │
...
│  PM writes: .claude/session/messages/developer/msg-pm-001.json    │
│  {                                                                  │
│    "type": "task_assign",                                         │
