---
description: Worker agent (Developer/QA/TechArtist/GameDesigner) in event-driven mode
agent: ralph-developer
---

# EVENT-DRIVEN MODE - Worker

You are the **$ARGUMENTS** in **EVENT-DRIVEN MULTI-AGENT** mode.
