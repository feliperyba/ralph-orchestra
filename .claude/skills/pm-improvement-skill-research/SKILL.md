...
|-------|------------------------|-----------------|
| **PM** | pm-organization-task-selection, pm-retrospective-facilitation, pm-organization-prd-reorganization, pm-improvement-self-improvement, shared-worker-worktree, AGENT.md | Task assignment issues, retrospective gaps, PRD not reorganized, agent workspace conflicts |
| **Developer** | dev-r3f-r3f-fundamentals, dev-validation-feedback-loops, dev-typescript-typescript-basics, dev-r3f-r3f-physics, AGENT.md | Code quality issues, failed builds, type errors, worktree violations |
...
- `.claude/skills/dev-typescript-typescript-basics/` — TypeScript best practices
