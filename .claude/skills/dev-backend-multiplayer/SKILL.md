...
description: Server-authoritative multiplayer development with Colyseus framework
category: architectural
depends-on: []
---

# Backend Multiplayer Skill

> "All gameplay logic belongs on the server. Clients only send inputs."

## When to Use This Skill

Use for **EVERY gameplay feature** in this project. This is a real-time multiplayer game - server authority is not optional.
...
- [agents/developer/skills/r3f-performance.md](r3f-performance.md) — Client-side prediction patterns
