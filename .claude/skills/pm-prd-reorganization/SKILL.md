...
1. Search for related existing task by keyword
...
6. FOR each requirement/action item:
   a. Check if covered by existing PRD task
   b. If NOT covered: CREATE new task
   c. If partially covered: UPDATE existing task

7. REORGANIZE task priorities and dependencies

8. WRITE updated prd.json

9. COMMIT with message:
   "Retrospective [N]: Reorganized PRD with [X] new tasks from GDD/retrospective"

10. SEND prd_reorganized message to workers:
   {
...
- [ ] Task dependencies are accurate and acyclic
