...
description: Creates custom GLSL/TSL shaders for visual effects. Use proactively when implementing shader materials, SDF geometry, or GPU-accelerated effects.
category: techartist
---
...
| Topic | Reference |
|-------|-----------|
| Texture loading in Vite | [patterns/texture-loading.md](patterns/texture-loading.md) |
...
- [ ] See [patterns/texture-loading.md](patterns/texture-loading.md) for texture handling

## Reference

- [Book of Shaders](https://thebookofshaders.com/)
- [Shadertoy](https://www.shadertoy.com/) — Shader gallery
- [ta-shader-sdf](../ta-shader-sdf/SKILL.md) — SDF functions
- [ta-r3f-materials](../ta-r3f-materials/SKILL.md) — Material basics
- [patterns/texture-loading.md](patterns/texture-loading.md) — Texture loading patterns
