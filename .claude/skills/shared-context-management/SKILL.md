...
version: 2.0
changelog: "MAJOR: Replaced external Python/PowerShell scripts with built-in /context command. Added context_checkpoint message format for watchdog integration. Added task complexity detection guidelines."
keywords: [context, reset, checkpoint, watchdog, monitoring]
user-invocable: true
---
...
When context >= 70%, send this message to watchdog:
...
- [message-queue.ps1](../../scripts/message-queue.ps1) — Message queue functions
