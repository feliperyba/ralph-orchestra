...
$messageQueueModule = Join-Path $PSScriptRoot "..\message-queue.ps1"
if (Test-Path $messageQueueModule) {
    . $messageQueueModule
} else {
    Write-Warning "[WATCHDOG] message-queue.ps1 not found - some features may not work"
}
